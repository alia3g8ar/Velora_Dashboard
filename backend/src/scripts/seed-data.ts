...
import { Audit } from '../modules/crm/entities/audit.entity';
...
import { EventCategory } from '../modules/crm/entities/event-category.entity';
import { Event } from '../modules/crm/entities/event.entity';
import { TaskStage } from '../modules/crm/entities/task-stage.entity';
...
import {
    ...
    Industry,
    Role,
} from '../modules/crm/enums';

export const DEMO_EMAIL = 'aliasghararyayimehr@gmail.com';
...
/**
 * Truncates the CRM schema and reseeds the demo data set. Used by the
 * `seed:demo` script and by the hourly demo auto-reset job. All imports are
 * relative so this module also runs from the compiled `dist` output.
 */
export async function seedDemoData(
    ...
    const taskData: Array<{
    ...
    }> = [
        {
            ...
            description: 'Consolidate pipeline data from all sales executives.',
    ...
    const eventData = [
        {
            ...
            description: 'Understand requirements for the platform rollout.',
            color: '#1677FF',
    ...
    return { demoEmail: DEMO_EMAIL, demoPassword: DEMO_PASSWORD, counts };
}
